...
abstract class Screen {
    ...
    static void start(Stage primaryStage, int gameMode) { // 1 = PVP, 0 = PVE
        ...
        generatePanel(tableP1, tableP2, gridPane);
    ...
    private static void generatePanel(Button[][] tableP1, Button[][] tableP2, GridPane gridPane) { /* player = 1 ou 2 */     
        /*-------------------Player1-----------------------*/
        ...
        Button orientationP1 = new Button ("Orientation");
        add(gridPane, orientationP1, 11, 2, 100, 35);
        
        Button shipP1 = new Button ("Ship");
        ...
        Button orientationP2 = new Button ("Orientation");
        add(gridPane, orientationP2, 26, 2, 100, 35);
        
        Button shipP2 = new Button ("Ship");
        add(gridPane, shipP2, 26, 3, 100, 35);
        
        addColumnGap(gridPane, 27, 10);
    }
    
    private static void add(GridPane grid, Button add, int column, int line, int sizeX, int sizeY) {
